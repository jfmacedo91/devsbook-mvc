<div class="box feed-item">
  <div class="box-body">
    ...
    <div class="feed-item-body mt-10 m-width-20">
      ...
      empresas.<br /><br />
      Este sistema permite que vários funcionários/colaboradores da empresa atendam um mesmo número de WhatsApp, mesmo
      que estejam trabalhando remotamente, sendo que cada um acessa com um login e senha particular....
    </div>
